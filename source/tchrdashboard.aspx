...
.style5 {font-size: 18px; font-weight: bold; color: #FFFFCC; }
.style6 {color: #FFFFCC}
a {
	font-family: Calibri;
	font-size: 16px;
  ...
  <div id="apDiv15">
    <table width="100%" height="282" border="0">
      <tr>
        ...
        <td bgcolor="#0D152E"><div align="center"><span class="style5">Home</span></div></td>
      </tr>
      <tr>
        <td height="38" colspan="2" bgcolor="#0D152E"><div align="center"><span class="style2"><span class="style6">Teacher Dashboard</span></span></div></td>
        </tr>
      <tr>
        <td height="38" bgcolor="#CCCCCC"><img src="../images/clllss.png" width="25" height="25" /></td>
        <td bgcolor="#CCCCCC"><strong><a href="teacherclass.aspx">Class Detail &amp; Section</a></strong></td>
      </tr>
      <tr>
        <td height="38" bgcolor="#CCCCCC"><img src="../images/confirrrr.png" width="25" height="25" /></td>
        <td bgcolor="#CCCCCC"><strong><a href="teachrstuconfirm.aspx">Student Confirmation</a></strong></td>
      </tr>
      <tr>
        <td height="38" bgcolor="#CCCCCC"><img src="../images/ssssss.png" width="25" height="25" /></td>
        <td bgcolor="#CCCCCC"><strong><a href="teachernotesuplod.aspx">Student Notes Upload</a></strong></td>
      </tr>
      <tr>
        <td height="38" bgcolor="#CCCCCC"><img src="../images/nnn.png" width="25" height="25" /></td>
        <td bgcolor="#CCCCCC"><strong><a href="teacherstunotice.aspx">Student Notice</a></strong></td>
      </tr>
      <tr>
        <td width="17%" height="38" bgcolor="#CCCCCC"><div align="center" class="style2"><img src="../images/bb.png" width="25" height="25" /></div></td>
        <td width="83%" bgcolor="#CCCCCC"><strong><a href="teacherschlnotice.aspx">School Notice</a></strong></td>
      </tr>
    </table>
  </div>
  <div id="apDiv16">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <tr>
        <td height="57" colspan="5" bgcolor="#0D152E"><span class="style7">Teacher Dashboard</span></td>
      </tr>
      <tr>
        <td colspan="5"><p align="justify">This study investigates how teachers use dashboards in primary school   classrooms. The performance is displayed on teacher   dashboards. This study examines how teachers use the dashboards. Teacher dashboard   consultations and resulting pedagogical actions were observed in 38   mathematics lessons. The teachers elaborate on how they reflect on and make sense of the   information on the dashboard. The results showed that teachers consulted   the dashboard . Teachers activated   existing knowledge about students and the class to interpret dashboard   information.</p>
          <p align="justify"> Task and process feedback were the pedagogical actions most   often used following dashboard consultation. Additionally, teachers who   consulted the dashboard more often activated more and more diverse   pedagogical knowledge to interpret the data and, consequently, gave more   and more diverse feedback. These results indicated that teacher   dashboards were indeed influencing teachers' pedagogical actions in   their daily classroom activities. This study provided the first evidence   that dashboards progressively impact teaching practice and initiate   more profound behavioral changes as teachers become more proficient in   using them.</p></td>
        </tr>
    </table>
  </div>
  </div>
