...
<script runat="server">
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\snapwork.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        sql = "insert into tchrnotice values('" & t1.Text & "','" & d1.Text & "','" & d2.Text & "','" & t2.Text & "','" & t3.Text & "'," & t4.Text & ",'" & t5.Text & "','" & t6.Text & "','" & Label1.Text & "')"
        datareader.InsertCommand = New Data.SqlClient.SqlCommand(sql, conn)
        datareader.InsertCommand.ExecuteScalar()
        MsgBox("school teacher notification has been saved")
        conn.Close()
        t1.Text = ""
        t2.Text = ""
        t3.Text = ""
...
<div id="apDiv1">
  ...
  <div id="apDiv16">
    <table width="100%" height="328" border="0">
      ...
      <tr>
        <td height="32" colspan="3" bgcolor="#0d152e"><span class="style5">Teacher Notification</span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="28"><strong>Teacher ID</strong></td>
        <td colspan="2">
      ...
      <tr>
        <td class="style6"><strong>Teacher Name</strong></td>
        <td colspan="2" class="style6">
            <asp:TextBox ID="t2" runat="server"></asp:TextBox>
          </td>
      </tr>
      <tr>
        <td height="26"><strong>Teacher Email</strong></td>
        <td colspan="2">
      ...
      <tr>
        <td class="style6"><strong>Notification Subject</strong></td>
        <td colspan="2" class="style6">
      ...
      <tr>
        <td height="30">
            <asp:Button ID="Button1" runat="server" BackColor="#0D152E" Font-Bold="True" 
                ForeColor="White" Text="Submit" Width="26%" onclick="Button1_Click" />
          </td>
        <td colspan="2">
            <asp:Button ID="Button2" runat="server" BackColor="#0D152E" Font-Bold="True" 
                ForeColor="White" Height="40%" Text="Reset" Width="21%" 
