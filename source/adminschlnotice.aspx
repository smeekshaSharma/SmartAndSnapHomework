...
<script runat="server">
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        conn.Open()
        command = New Data.SqlClient.SqlCommand("select count(*) from aminschlnotic where  State='" & d1.Text & "' and City='" & d2.Text & "' and SchoolName='" & d3.Text & "' and NoticeSubject='" & t2.Text & "'")
        command.Connection = conn
        count = command.ExecuteScalar
        If (count > 0) Then
            MsgBox("this school notice is alredy exists")
            t2.Text = ""
            conn.Close()
        Else
            sql = "insert into aminschlnotic values('" & t1.Text & "','" & UCase(d1.Text) & "','" & UCase(d2.Text) & "','" & UCase(d3.Text) & "','" & UCase(t2.Text) & "','" & t3.Text & "')"
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        count = command.ExecuteScalar
        If (count > 0) Then
            command = New Data.SqlClient.SqlCommand("select State from aminschlnotic where State='" & d1.Text & "' and City='" & d2.Text & "' and SchoolName='" & d3.Text & "' and NoticeSubject ='" & t2.Text & "'")
            command.Connection = conn
            d1.Text = command.ExecuteScalar
            command = New Data.SqlClient.SqlCommand("select City from aminschlnotic where State='" & d1.Text & "' and City='" & d2.Text & "' and SchoolName='" & d3.Text & "' and NoticeSubject ='" & t2.Text & "'")
            command.Connection = conn
            d2.Text = command.ExecuteScalar
            command = New Data.SqlClient.SqlCommand("select SchoolName from aminschlnotic where State='" & d1.Text & "' and City='" & d2.Text & "' and SchoolName='" & d3.Text & "' and NoticeSubject ='" & t2.Text & "'")
            command.Connection = conn
            d3.Text = command.ExecuteScalar
            command = New Data.SqlClient.SqlCommand("select CurrentDate from aminschlnotic where State='" & d1.Text & "' and City='" & d2.Text & "' and SchoolName='" & d3.Text & "' and NoticeSubject ='" & t2.Text & "'")
            command.Connection = conn
            t1.Text = command.ExecuteScalar
            command = New Data.SqlClient.SqlCommand("select NoticeSubject from aminschlnotic where State='" & d1.Text & "' and City='" & d2.Text & "' and SchoolName='" & d3.Text & "' and NoticeSubject ='" & t2.Text & "'")
            command.Connection = conn
            t2.Text = command.ExecuteScalar
            command = New Data.SqlClient.SqlCommand("select NoticeDiscription from aminschlnotic where State='" & d1.Text & "' and City='" & d2.Text & "' and SchoolName='" & d3.Text & "' and NoticeSubject ='" & t2.Text & "'")
            command.Connection = conn
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\snapwork.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        command = New Data.SqlClient.SqlCommand("delete from aminschlnotic where State='" & d1.Text & "' and City='" & d2.Text & "' and SchoolName='" & d3.Text & "' and NoticeSubject ='" & t2.Text & "'")
        command.Connection = conn
        command.ExecuteScalar()
        MsgBox("admin school notice has been deleted")
        t1.Text = ""
        t2.Text = ""
        t3.Text = ""
    End Sub
    ...
    Protected Sub Button4_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\snapwork.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        command = New Data.SqlClient.SqlCommand("update aminschlnotic set State='" & d1.Text & "' where  City='" & d2.Text & "' and  SchoolName='" & d3.Text & "' and NoticeSubject ='" & t2.Text & "'")
        command.Connection = conn
        command.ExecuteScalar()
        MsgBox("admin school notice has been update")
        t1.Text = ""
        t2.Text = ""
        t3.Text = ""
    End Sub
...
&nbsp;
  ...
  <div id="apDiv15">
    <table width="100%" height="258" border="0">
      ...
      <tr>
        <td height="21" bgcolor="#CCCCCC"><img src="../images/stuuu.png" alt="s" width="25" height="25" /></td>
  ...
  <div id="apDiv16">
    <table width="100%" height="59" border="0">
      ...
      <tr>
        <td height="26" colspan="5" bgcolor="#0d152e"><span class="style6">Admin School Notice Detail</span></td>
      </tr>
      <tr>
        <td height="4" colspan="5"><hr /></td>
      </tr>
      <tr>
        <td colspan="4" class="style20"><strong>Current Date</strong></td>
        <td class="style20">
      ...
      <tr>
        <td colspan="4"><strong>City</strong></td>
        <td>
      ...
      <tr>
        <td colspan="4"><strong>School Name</strong></td>
        <td>
            <asp:DropDownList ID="d3" runat="server">
                <asp:ListItem>Select Any one</asp:ListItem>
                <asp:ListItem>DAV International</asp:ListItem>
                <asp:ListItem>DAV Public School</asp:ListItem>
                <asp:ListItem>Holy Heart Presidency School</asp:ListItem>
                <asp:ListItem>Spring Dale School</asp:ListItem>
                <asp:ListItem>Khalsa College school</asp:ListItem>
            </asp:DropDownList>
          </td>
      </tr>
      <tr>
        <td colspan="4"><strong>Notice Subject</strong></td>
        <td>
            <asp:TextBox ID="t2" runat="server"></asp:TextBox>
          </td>
      </tr>
      <tr>
        <td colspan="4" class="style19"><strong>Notice Description</strong></td>
        <td class="style19">
            <asp:TextBox ID="t3" runat="server"></asp:TextBox>
          </td>
      </tr>
      <tr>
        <td colspan="4"><strong>PDF/ Document Upload</strong></td>
        <td>
