...
<script runat="server">
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\snapwork.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        command = New Data.SqlClient.SqlCommand("select count(*) from clasdetail where ClassName='" & d1.Text & "' and Section='" & d2.Text & "'and TeacherEmail='" & Label1.Text & "'")
        command.Connection = conn
        count = command.ExecuteScalar
        If (count > 0) Then
            MsgBox("This Class Detail Alredy Exist")
            conn.Close()
        Else
            sql = "insert into clasdetail values('" & d1.Text & "','" & d2.Text & "','" & Label1.Text & "')"
            datareader.InsertCommand = New Data.SqlClient.SqlCommand(sql, conn)
            datareader.InsertCommand.ExecuteScalar()
            MsgBox("Class Detail Has Been Saved")
            conn.Close()
        End If
    End Sub
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\snapwork.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        command = New Data.SqlClient.SqlCommand("delete from clasdetail where ClassName='" & d1.Text & "' and Section='" & d2.Text & "'and TeacherEmail='" & Label1.Text & "'")
        command.Connection = conn
        command.ExecuteScalar()
        MsgBox("Class Detail Has Been Deleted")
        conn.Close()
...
<div id="apDiv1">
  ...
  <div id="apDiv15">
    <table width="100%" height="326" border="0">
      ...
      <tr>
        <td width="17%" height="38" bgcolor="#CCCCCC"><div align="center" class="style2"><img src="../images/bb.png" alt="" width="25" height="25" /></div></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <tr>
        <td colspan="5" bgcolor="#0D152E"><span class="style9">Class Detail</span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="41">
            <asp:Button ID="Button1" runat="server" BackColor="#0D152E" Font-Bold="True" 
                Font-Size="Large" ForeColor="White" Text="Save" Width="58%" 
                onclick="Button1_Click" />
          </td>
        <td colspan="4">
            <asp:Button ID="Button2" runat="server" BackColor="#0D152E" Font-Bold="True" 
                Font-Size="Large" ForeColor="White" Text="Delete" Width="20%" 
