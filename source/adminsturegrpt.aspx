...
&nbsp;<asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" ForeColor="#0D152E" 
  ...
  <div id="apDiv15">
    <table width="100%" height="300" border="0">
      ...
      <tr>
        <td width="18%" height="27" bgcolor="#CCCCCC"><img src="../images/home.png" width="25" height="25" /></td>
        <td width="82%" bgcolor="#CCCCCC"><span class="style2"><a href="admindshboard.aspx">Home</a></span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="30" colspan="2" bgcolor="#0D152E"><div align="center"><span class="style8">Reports</span></div></td>
      </tr>
      <tr>
  ...
  <div id="apDiv16">
    <table width="100%" height="59" border="0">
      ...
      <tr>
        ...
        <td colspan="-2">
            <asp:DropDownList ID="d2" runat="server" Height="16px">
                <asp:ListItem>Select Any One</asp:ListItem>
            </asp:DropDownList>
          </td>
      </tr>
