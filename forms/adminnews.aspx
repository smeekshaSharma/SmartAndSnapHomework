...
<script runat="server">
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        conn.Open()
        command = New Data.SqlClient.SqlCommand("select count(*) from adminnews where NewsSubject='" & t2.Text & "'")
        command.Connection = conn
        count = command.ExecuteScalar
        If (count > 0) Then
            MsgBox("this admin new alredy exist")
            t2.Text = ""
            conn.Close()
        Else
            sql = "insert into adminnews values('" & t1.Text & "','" & UCase(t2.Text) & "','" & t3.Text & "')"
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        count = command.ExecuteScalar
        If (count > 0) Then
            command = New Data.SqlClient.SqlCommand("select NewsSubject from adminnews where  NewsSubject='" & t2.Text & "'")
            command.Connection = conn
            t2.Text = command.ExecuteScalar
            command = New Data.SqlClient.SqlCommand("select CurrentDate from adminnews where  NewsSubject='" & t2.Text & "'")
            command.Connection = conn
            t1.Text = command.ExecuteScalar
            command = New Data.SqlClient.SqlCommand("select NewsDiscription from adminnews where  NewsSubject='" & t2.Text & "'")
            command.Connection = conn
            t3.Text = command.ExecuteScalar
        Else
            MsgBox("adminnews is not find")
            t1.Text = ""
            t2.Text = ""
            t3.Text = ""
        End If
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        MsgBox("aadmin news has been deleted")
        t1.Text = ""
        t2.Text = ""
        t3.Text = ""
    End Sub
    ...
    Protected Sub Button4_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\snapwork.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        command = New Data.SqlClient.SqlCommand("update adminnews set NewsSubject='" & t2.Text & "'")
        command.Connection = conn
        command.ExecuteScalar()
        MsgBox("aadmin news has been update")
        t1.Text = ""
        t2.Text = ""
        t3.Text = ""
    End Sub
...
&nbsp;
  ...
  <div id="apDiv15">
    <table width="100%" height="301" border="0">
      ...
      <tr>
        <td height="32" bgcolor="#CCCCCC"><img src="../images/schhlll.png" width="25" height="25" /></td>
      ...
      <tr>
        <td height="32" bgcolor="#CCCCCC"><img src="../images/stuuu.png" width="25" height="25" /></td>
  ...
  <div id="apDiv16">
    <table width="100%" height="59" border="0">
      ...
      <tr>
        <td height="26" colspan="5" bgcolor="#0d152e"><span class="style6">Admin News Detail</span></td>
      </tr>
      <tr>
        <td height="4" colspan="5"><hr /></td>
      </tr>
      <tr>
        <td colspan="4"><strong>Current Date</strong></td>
        <td>
            <asp:TextBox ID="t1" runat="server" ontextchanged="t1_TextChanged" 
                style="height: 22px"></asp:TextBox>
          </td>
      </tr>
      <tr>
        <td colspan="4"><strong>News Subject</strong></td>
        <td>
            <asp:TextBox ID="t2" runat="server"></asp:TextBox>
          </td>
      </tr>
      <tr>
        <td colspan="4"><strong>News Description </strong></td>
        <td>
